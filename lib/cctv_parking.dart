  ...
  try {
    ...
    if (mounted) {
      setState(() {
        ...
        final camerasMap = filteredCameras.map((c) => {
          'id': c.cameraId,       // Digunakan untuk label di kartu
          'camera_id': c.cameraId, // ID asli untuk parameter API (Save/Delete)
          'location': c.location,
          'status': c.status,
          'type': c.type,
          'ip_address': c.ipAddress, // <--- WAJIB ADA AGAR IP MUNCUL SAAT EDIT
...
Widget _buildContent(BuildContext context, BoxConstraints constraints) {
  final isMobile = isMobileScreen(context); // Pastikan fungsi helper ini tersedia
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      // --- TITLE SECTION ---
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(
                Icons.videocam, 
                size: 32, 
                color: Colors.white, // Warna Putih untuk kontras terhadap biru tema
              ),
            ),
        ...
        child: const Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text(
                'There Are No Registered Camera For Parking Area Yet',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey,
                ),
