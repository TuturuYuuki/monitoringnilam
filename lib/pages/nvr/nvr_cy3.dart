...
class NVRPageCY3 extends StatefulWidget {
  const NVRPageCY3({super.key});

  @override
  State<NVRPageCY3> createState() => _NVRPageCY3State();
}

class _NVRPageCY3State extends State<NVRPageCY3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/nvr-monitoring-CY3'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/nvr-monitoring-CY3',
              child: SingleChildScrollView(
                child: LayoutBuilder(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('NVR Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: CY 3', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
