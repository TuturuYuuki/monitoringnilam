...
class NVRPageCY2 extends StatefulWidget {
  const NVRPageCY2({super.key});

  @override
  State<NVRPageCY2> createState() => _NVRPageCY2State();
}

class _NVRPageCY2State extends State<NVRPageCY2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/nvr-monitoring-CY2'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/nvr-monitoring-CY2',
              child: SingleChildScrollView(
                child: LayoutBuilder(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('NVR Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: CY 2', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
