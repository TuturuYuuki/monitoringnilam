...
class NVRPageGATE extends StatefulWidget {
  const NVRPageGATE({super.key});

  @override
  State<NVRPageGATE> createState() => _NVRPageGATEState();
}

class _NVRPageGATEState extends State<NVRPageGATE> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/nvr-monitoring-GATE'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/nvr-monitoring-GATE',
              child: SingleChildScrollView(
                child: LayoutBuilder(
          ...
          child: Container(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  const Icon(Icons.dvr, size: 40, color: Colors.white54),
                  const SizedBox(height: 12),
                  Text(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('NVR Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: GATE', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
