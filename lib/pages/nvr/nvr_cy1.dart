...
class NVRPageCY1 extends StatefulWidget {
  const NVRPageCY1({super.key});

  @override
  State<NVRPageCY1> createState() => _NVRPageCY1State();
}

class _NVRPageCY1State extends State<NVRPageCY1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/nvr-monitoring-cy1'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/nvr-monitoring-cy1',
              child: SingleChildScrollView(
                child: LayoutBuilder(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('NVR Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: CY 1', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
