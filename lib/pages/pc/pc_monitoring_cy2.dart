...
class PCMonitoringCY2Page extends StatefulWidget {
  const PCMonitoringCY2Page({super.key});

  @override
  State<PCMonitoringCY2Page> createState() => _PCMonitoringCY2PageState();
}

class _PCMonitoringCY2PageState extends State<PCMonitoringCY2Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/pc-monitoring-cy2'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/pc-monitoring-cy2',
              child: SingleChildScrollView(
                child: LayoutBuilder(
