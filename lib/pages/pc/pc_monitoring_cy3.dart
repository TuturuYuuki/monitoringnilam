...
class PCMonitoringCY3Page extends StatefulWidget {
  const PCMonitoringCY3Page({super.key});

  @override
  State<PCMonitoringCY3Page> createState() => _PCMonitoringCY3PageState();
}

class _PCMonitoringCY3PageState extends State<PCMonitoringCY3Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/pc-monitoring-cy3'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/pc-monitoring-cy3',
              child: SingleChildScrollView(
                child: LayoutBuilder(
