...
class PCMonitoringGatePage extends StatefulWidget {
  const PCMonitoringGatePage({super.key});

  @override
  State<PCMonitoringGatePage> createState() => _PCMonitoringGatePageState();
}

class _PCMonitoringGatePageState extends State<PCMonitoringGatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/pc-monitoring-gate'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/pc-monitoring-gate',
              child: SingleChildScrollView(
                child: LayoutBuilder(
