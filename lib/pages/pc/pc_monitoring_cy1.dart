...
class PCMonitoringCY1Page extends StatefulWidget {
  const PCMonitoringCY1Page({super.key});

  @override
  State<PCMonitoringCY1Page> createState() => _PCMonitoringCY1PageState();
}

class _PCMonitoringCY1PageState extends State<PCMonitoringCY1Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/pc-monitoring-cy1'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/pc-monitoring-cy1',
              child: SingleChildScrollView(
                child: LayoutBuilder(
  ...
  void _confirmDeletePC(PCModel pc) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete PC ${pc.pcId}?', style: const TextStyle(color: Colors.white70)),
        actions: [
