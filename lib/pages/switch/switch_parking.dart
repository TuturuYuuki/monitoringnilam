...
class SwitchPagePARKING extends StatefulWidget {
  const SwitchPagePARKING({super.key});

  @override
  State<SwitchPagePARKING> createState() => _SwitchPagePARKINGState();
}

class _SwitchPagePARKINGState extends State<SwitchPagePARKING> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/switch-monitoring-parking'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/switch-monitoring-parking',
              child: SingleChildScrollView(
                child: LayoutBuilder(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('Switch Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: PARKING', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
