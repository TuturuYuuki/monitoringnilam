...
class SwitchPageCY1 extends StatefulWidget {
  const SwitchPageCY1({super.key});

  @override
  State<SwitchPageCY1> createState() => _SwitchPageCY1State();
}

class _SwitchPageCY1State extends State<SwitchPageCY1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/switch-monitoring-CY1'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/switch-monitoring-CY1',
              child: SingleChildScrollView(
                child: LayoutBuilder(
