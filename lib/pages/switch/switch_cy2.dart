...
class SwitchPageCY2 extends StatefulWidget {
  const SwitchPageCY2({super.key});

  @override
  State<SwitchPageCY2> createState() => _SwitchPageCY2State();
}

class _SwitchPageCY2State extends State<SwitchPageCY2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const GlobalHeaderBar(currentRoute: '/switch-monitoring-cy2'),
          Expanded(
            child: GlobalSidebarNav(
              currentRoute: '/switch-monitoring-cy2',
              child: SingleChildScrollView(
                child: LayoutBuilder(
        ...
        Row(
          children: [
            ...
            const Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [Text('Switch Monitoring', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.2)), Text('Location: CY 2', style: TextStyle(color: Colors.white70, fontSize: 13))],
              ),
            ),
          ],
        ),
